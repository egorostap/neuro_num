# нейронка для распознавания цифр датасет мнист v1
...
def search_nums(lst):
  ...
  lst_out = list(lst)
  result = nums[lst_out.index(max(lst_out))]
  return f'вероятно цифра на картинке: {result}'
...
if __name__ == "__main__":
    ...
    for pic in pics:
      print(search_nums(cnn_digits_predict(model, pic)))
